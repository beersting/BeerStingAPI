   ...
   public class MySQL : IDB 
    {
        ...
        public string DatabaseType { get { return BeerSting.Api.Enums.Database.MYSQL.ToString() ; } }

        public void Connect(object dbConnection)
        {
            m_Connection = (MySqlConnection)dbConnection;
        }
        ...
        {
            string connStr = String.Format("server={0};port={1:g}; user id={2}; password={3}; database={4};",
        ...
        public System.Data.DataTable Query(string query, params object[] param)
        {
            ...
            MySqlDataAdapter adapt = new MySqlDataAdapter(query, m_Connection);
